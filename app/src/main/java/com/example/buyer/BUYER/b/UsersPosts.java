...
//
//public class UsersPosts extends AppCompatActivity implements PostAdapter.PostDeleteListener {
//    private RecyclerView recyclerView;
//      private ArrayList<Post> postList;
//    @Override
//    protected void onCreate(Bundle savedInstanceState) {
...
//            postList = new ArrayList<>();
//
//            PostAdapter postAdapter = new PostAdapter(postList, getApplicationContext(), this); // передаем интерфейс
//            LinearLayoutManager layoutManager = new LinearLayoutManager(getApplicationContext(), LinearLayoutManager.VERTICAL, false);
//            recyclerView.setLayoutManager(layoutManager);
//            recyclerView.setNestedScrollingEnabled(false);
//            recyclerView.setAdapter(postAdapter);
...
//                    for (DataSnapshot dataSnapshot : snapshot.getChildren()) {
//                        Post post = dataSnapshot.getValue(Post.class);
//                        if (post != null && currentUser.getUid().equals(post.getUserId())) {
//                            postList.add(post);
//                        }
//                    }
//                    postAdapter.notifyDataSetChanged();
...
//                    Toast.makeText(UsersPosts.this, "Post deleted", Toast.LENGTH_SHORT).show();
//                })
//                .addOnFailureListener(e -> {
//                    Toast.makeText(UsersPosts.this, "Failed to delete post: " + e.getMessage(), Toast.LENGTH_SHORT).show();
//                });
//    }
//}