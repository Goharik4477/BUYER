...
import com.example.buyer.BUYER.models.ChatMessage;
...
//
//        // Получаем receiverUserId из Intent
//        String receiverUserId = getIntent().getStringExtra(Constants.KEY_RECEIVER_USER_ID);
//
//        // Получаем данные пользователя из Realtime Database
//        DatabaseReference reference = FirebaseDatabase.getInstance().getReference("Registered Users");
//        reference.child(receiverUserId).addListenerForSingleValueEvent(new ValueEventListener() {
//            @Override
//            public void onDataChange(@NonNull DataSnapshot snapshot) {
//                ReadWriteUsersdetails user = snapshot.getValue(ReadWriteUsersdetails.class);
//                if (user != null) {
//                    // Отображаем имя пользователя
//                    binding.textName.setText(user.name); // или как у тебя называется имя
//                    // Вы можете также загрузить дополнительные данные пользователя, если они есть
//                }
//            }
//
//            @Override
//            public void onCancelled(@NonNull DatabaseError error) {
//                Toast.makeText(ChatActivity.this, "Failed to load user", Toast.LENGTH_SHORT).show();
//            }
//        });
//
//        // Устанавливаем имя получателя, если оно доступно
...
//                    receiverUser.name = userDetails.name;
//                    receiverUser.image = userDetails.profileImage; // если есть поле с картинкой
//                    binding.textName.setText(userDetails.name);
//                    init(); // теперь инициализация после загрузки данных
//                    listenMessages();
//                    listenAvailabilityOfReceiver();
//                }
//            }
...
//                    receiverUser.id = receiverUserId;
//                    receiverUser.name = userDetails.name;
////                    receiverUser.image = userDetails.image;  // убедись, что поле есть
////                    receiverUser.token = userDetails.token;  // убедись, что поле есть
//
//                    binding.textName.setText(receiverUser.name);
//
//                    init();
